...
logitna_net = build_mlp(obs_dim, ac_dim, 2, 8)
baseline_network = build_mlp(obs_dim, 1, 2, 4)
...
args = PGConfig('CartPole-v0', 100, batch_size=5000, scalar_log_freq=10,
                logits_na=logitna_net, baseline_optim_spec=baseline_optim_spec,
