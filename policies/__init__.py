...
from policies.MLP_policy import MLPPolicyAWAC, MLPPolicyPG, MLPPolicyAC, MLPPolicySL, MLPPolicySAC
...
__all__ = ['ArgmaxPolicy', 'MLPPolicyAC', 'EpsilonArgmaxGreedy', 'MLPPolicyAWAC', 'GradientPolicy',
           'MLPPolicySL', 'MLPPolicyPG', 'MLPPolicySL', 'MLPPolicySAC', 'MPCPolicy']
